  ...
  $.app.menu = {
    ...
    change: function (defMenu) {
      ...
      $('ul.dropdown-menu [data-toggle=dropdown]').on('click', function (event) {
        ...
        //----------------added by ali
        var url = event.currentTarget.attributes['data-selectedmenu'];
        $('body').trigger('click', [url, this, false]);
        //-----------------
    ...
    changeMenu: function (screen) {
      //added by ali
      var url = window.location.pathname.replace("/systemX", '');
      $("ul[data-menu='menu-navigation'] a[data-selectedmenu='" + url + "']").parents('li').addClass('active');
      $("ul[data-menu='menu-navigation'] a[data-selectedmenu='" + url + "']").addClass('active');
    ...
    bind_events: function () {
      ...
      $('.navigation-main').on('mouseenter.app.menu', 'li', function () {
        ...
        if ($body.hasClass('menu-collapsed') && $body.data('menu') != 'vertical-menu-modern') {
          ...
          // Title
          var menuTitle = $this.find('span.menu-title').first().clone(),
            tempTitle,
            tempLink;
          if (!$this.hasClass('has-sub')) {
            ...
            if (tempTitle !== '') {
              ...
              menuTitle.attr("href", "javascript:;");
              $(menuTitle).on('click',function(e){
                window.history.pushState(null, '',tempLink);
      ...
      .on('mouseleave.app.menu', 'li', function () {
        ...
        //added by ali
        if (!$(this).hasClass('has-sub')) {
          var url = $(this).children('a')[0].attributes['data-selectedmenu'];
          $('body').trigger('click', [url, this, true]);
        }
      ...
      $(ul).find('li a').each(function(){
        ...
        $(this).on('click',function(e){
          if($(this).closest('li').hasClass('open')) {
            $(this).closest('li').hasClass('open').removeClass('open');
          } 
          else {
            $(this).parent().siblings().removeClass('open');
        ...
        // let Link = "ng-reflect-router-link";
        // $(this).attr(Link, href);
